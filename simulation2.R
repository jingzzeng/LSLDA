## ---------------------------------------- ##
# This file implements the LSLDA algorithm on simulated data generated from Model (M2) (Section 5).
## ---------------------------------------- ##
rm(list = ls())
...
foo <- function(i){
  ...
  # ---------------- lslda --------------- #
  fit_lslda <- lslda_val(x_train, y_train, x_val, y_val, lam1_maxfac=1, n1=20, metric = "acc")
